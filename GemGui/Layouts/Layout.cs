...
namespace GemGui
{
    ...
    {
        public static Rectangle Center(Rectangle What, Rectangle Area)
        {
        ...
        public static Rectangle Float(Rectangle What, Rectangle Within, Placements Placement, int Padding)
        {
		...
		public static Rectangle Pad(Rectangle what, int Padding)
		{
